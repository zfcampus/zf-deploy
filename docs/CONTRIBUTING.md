...
[create a proposal](https://github.com/zfcampus/zf-deploy/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zfcampus/zf-deploy.git
  $ cd zf-deploy
  ```
...
2. Fork the repository (https://github.com/zfcampus/zf-deploy)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zf-deploy.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zf-deploy.git
